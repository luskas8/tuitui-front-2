...
export default function Squeleton({ blocks = 3, removeTitle = false }: SqueletonProps) {
  return (
    <div className="w-full flex flex-col items-center">
      {removeTitle ? null : <h2 className="font-bold text-xl flex flex-wrap">{loadingMessages()}</h2>}

...
import type { ButtonProps } from './FlowbiteButton';
import { DeepPartial } from '.';
import { useTheme } from './Flowbite';
import type { FloatingProps, FlowbiteFloatingTheme } from './Floating';
import { Floating } from './Floating';
import { mergeDeep } from 'flowbite-react/lib/esm/helpers/merge-deep.js';
import type { FlowbiteDropdownDividerTheme } from './Dropdown/DropdownDivider';
import { DropdownDivider } from './Dropdown/DropdownDivider';
import type { FlowbiteDropdownHeaderTheme } from './Dropdown/DropdownHeader';
import { DropdownHeader } from './Dropdown/DropdownHeader';
import type { FlowbiteDropdownItemTheme } from './Dropdown/DropdownItem';
...
const DropdownComponent: FC<DropdownProps> = ({
  ...
  return (
    ...
    >
      <div ref={ref} className={theme.inlineWrapper}>
        {label}
